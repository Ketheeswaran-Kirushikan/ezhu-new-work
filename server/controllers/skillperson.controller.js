...
const verifyUser = async (req, res) => {
  ...
  try {
    ...
    const msg = {
      ...
      text: `Hello ${userRequest.first_name},\n\nYour payment has been successfully completed.\n\nClick on the following link to proceed with your account setup: https://ezhu-new-work.vercel.app/login\n\nYour email: ${userRequest.email}\nPassword: ${userRequest.password}\n\nThank you!`,
      html: `<h3>Hello ${userRequest.first_name},</h3><p>Your payment has been successfully completed.</p><p><a href="https://ezhu-new-work.vercel.app/login">Click here</a> to proceed with your account setup.</p><br><p>Your email: ${userRequest.email}<br>Password: ${newUser.password}<br><p>Thank you!</p>`,
    };
